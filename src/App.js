    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button className="homeButtons__touchdown" onClick={()=>newHomeScore(homeScore + 7)} >Home Touchdown</button>
          <button className="homeButtons__fieldGoal" onClick={()=>newHomeScore(homeScore + 3)}>Home Field Goal</button>
        </div>
